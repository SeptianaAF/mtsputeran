...
<div class="main_section_agile" id="home">
	<div class="agileits_w3layouts_banner_nav">
		<nav class="navbar navbar-default">
			...
			<h1><a class="navbar-brand" href="index.php"><i class="fa fa-leanpub" aria-hidden="true"></i> MTS Puteran</a></h1>
			...
			<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
				<nav class="link-effect-2" id="link-effect-2">
					<ul class="nav navbar-nav">
						...
						<li> <a class='effect-3 scroll' data-toggle='dropdown'>Ekstrakurikuler<span class='caret'></span> </a>
							<ul class='dropdown-menu'>
								<li><a href='pramuka.php' >Pramuka</a></li>
								<li><a href='keputrian.php' >Keputrian</a></li>
								<li><a href='pmr.php' >PMR</a></li>
								<li><a href='marchingband.php' >MarchingBand</a></li>
								<li><a href='penjas.php' >Penjas / Kaligrafi</a></li>
								<li><a href='btq.php' >BTQ</a></li>
							</ul>
						</li>
						<li class="active"><a href="fasilitas.php" class="effect-3">Fasilitas </a></li>
						<li>
